    ...
    var module = {};  
        ...
        module.join = function( config ){
            ...
            if( images.length > 0 )  
            {
                ...
                {
                    current = drawData[i];
                    context.drawImage(current.image, 0, 0, current.image.width, current.image.height, 0, 0, current.scaledWidth, current.scaledHeight); 
                }
            }  
        };

        module.fixOrientation = function(ctx, result) {
